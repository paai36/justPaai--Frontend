                ...
                <div className={styles.mainContent}>
                    ...
                    <div className={styles.bottom}>
                        <div className={styles.notices}>
                            ...
                            <ul>
                                {caseDetails?.Notices.length === 0 ? (
                                    <div className={styles.emptystate}>
                                        <img src="/noNotices.svg" alt=""></img>
                                        <p>Oops! You don't have any Notices</p>
                        ...
                        <div className={styles.invoices}>
                            ...
                            <ul>
                                {caseDetails?.Invoices.length === 0 ? (
                                    <div className={styles.emptystate}>
                                        <img src="/noInvoices.svg" alt=""></img>
                                        <p>Oops! You don't have any Invoices</p>
